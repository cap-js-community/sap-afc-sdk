...
const Files = {
  ...
  JAVA: [
    ...
    `srv/src/main/java/customer/${PROJECT}/ApplicationConfig.java``srv/src/main/java/customer/${PROJECT}/scheduling/CustomSchedulingProcessingHandler.java``srv/src/main/java/customer/${PROJECT}/scheduling/CustomSchedulingProviderHandler.java``srv/src/test/java/customer/${PROJECT}/scheduling/SchedulingProviderHandlerTest.java`,
  ],
  CF: ["mta.yaml"],
