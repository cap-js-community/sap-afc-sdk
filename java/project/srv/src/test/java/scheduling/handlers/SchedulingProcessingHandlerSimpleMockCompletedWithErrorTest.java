...
import scheduling.configuration.AFCSDKTestSimpleCompletedWithErrorConfig;
...
public class SchedulingProcessingHandlerSimpleMockCompletedWithErrorTest {
    ...
    void processJob() throws Exception {
        ...
        assertEquals(messageProvider.get("jobCompletedWithError", null, Locale.ENGLISH), jobResultMessages.get(0).getText());
