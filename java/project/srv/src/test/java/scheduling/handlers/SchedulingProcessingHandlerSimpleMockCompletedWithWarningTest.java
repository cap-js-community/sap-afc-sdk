...
import scheduling.configuration.AFCSDKTestSimpleCompletedWithWarningConfig;
...
@ContextConfiguration(classes = { OutboxTestConfig.class, AFCSDKTestSimpleCompletedWithWarningConfig.class })
public class SchedulingProcessingHandlerSimpleMockCompletedWithWarningTest {
    ...
    void processJob() throws Exception {
        ...
        assertEquals(messageProvider.get("jobCompletedWithWarning", null, Locale.ENGLISH), jobResultMessages.get(0).getText());
