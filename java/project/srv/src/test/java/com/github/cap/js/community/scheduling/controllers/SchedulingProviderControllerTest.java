package com.github.cap.js.community.scheduling.controllers;
...
import com.github.cap.js.community.scheduling.configuration.AFCSDKTestSimpleCompletedConfig;
...
public class SchedulingProviderControllerTest {
    ...
    public void getJobDefinitions() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition"))
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/JOB_1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name").value("JOB_1"));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?skip=0&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_1"));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?skip=-1&top=-1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_1"));
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?skip=-1&top=4"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(4));

        result = mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?skip=1"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?$expand=parameters"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6))
                .andExpect(jsonPath("$.value.[0].parameters").doesNotExist());

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?$filter=name eq 'JOB_1'"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));
    }
    ...
    public void getJobDefinitionsByName() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?name=JOB_1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?name=JOB_*"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?name=*OB_2"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));


        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?name=*OB*"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?name=*O*B*"))
                .andExpect(status().isOk())
    ...
    public void getJobDefinitionsBySearch() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=JOB_1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=JoB_"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=Ob_2"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=OB"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=O*B"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(0));
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=Job definition 1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=Job def"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=ob definition 1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?search=ob def"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(6));
    ...
    public void getJobParameterDefinitions() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters?top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("A"));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters?skip=1&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("B"));

        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters?skip=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(4))
                .andExpect(jsonPath("$[0].name").value("B"));
    }
    ...
    public void getJobs() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103"))
                .andExpect(jsonPath("$.name").value("JOB_1"))
                .andExpect(jsonPath("$.link").value("http://localhost:8080/launchpad.html#Job-monitor&/Job(3a89dfec-59f9-4a91-90fe-3c7ca7407103)"))
                .andExpect(status().isOk());

        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/Job"))
                .andExpect(header().string("Content-Type", "application/json"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/Job?skip=0&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_1"));

        mockMvc.perform(get("/api/job-scheduling/v1/Job?skip=-1&top=-1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_1"));
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/Job?skip=-1&top=4"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103?$expand=parameters"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.parameters").doesNotExist());

        mockMvc.perform(get("/api/job-scheduling/v1/Job?$filter=name eq 'JOB_1'"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(3));
    }
    ...
    public void getJobByReferenceID() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/Job?referenceID=8158cbab-a42b-4cb9-9656-8db72521d13d"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_2"))
    ...
    public void getJobByName() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/Job?name=JOB_2"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("JOB_2"));
    }
    ...
    public void getJobParameters() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103/parameters"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(5))
                .andExpect(jsonPath("$[0].name").value("A"))
                .andExpect(jsonPath("$[0].value").value("ABC"))
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103/parameters?top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("A"));

        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103/parameters?skip=1&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].name").value("B"));

        mockMvc.perform(get("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103/parameters?skip=1"))
                .andExpect(status().isOk());
    }
    ...
    public void getJobResults() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/Job/5a89dfec-59f9-4a91-90fe-3c7ca7407103/results"))
                .andExpect(status().isOk());

        mockMvc.perform(get("/api/job-scheduling/v1/Job/5a89dfec-59f9-4a91-90fe-3c7ca7407103/results?top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].type").value(ResultTypeCode.DATA));

        mockMvc.perform(get("/api/job-scheduling/v1/Job/5a89dfec-59f9-4a91-90fe-3c7ca7407103/results?skip=1&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].type").value(ResultTypeCode.LINK));

        mockMvc.perform(get("/api/job-scheduling/v1/Job/5a89dfec-59f9-4a91-90fe-3c7ca7407103/results?skip=1"))
                .andExpect(status().isOk());
    }
    ...
    public void getJobResultMessages() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages"))
                .andExpect(status().isOk());

        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages?top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
                .andExpect(jsonPath("$[0].text").value("This is an error"))
                .andExpect(jsonPath("$[0].severity").value(MessageSeverityCode.ERROR));

        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages?skip=1&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages?skip=2&top=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(1))
        ...
        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages?skip=1"))
                .andExpect(status().isOk());

        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/a2eb590f-9505-4fd6-a5e2-511a1b2ff47f/messages"))
                .andExpect(status().isOk())
                .andExpect(content().json("[]"));

        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/c2eb590f-9505-4fd6-a5e2-511a1b2ff47f?$expand=messages"))
                .andExpect(status().isOk())
    ...
    public void getJobResultData() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobResult/b2eb590f-9505-4fd6-a5e2-511a1b2ff47f/data"))
                .andExpect(status().isOk())
    ...
    public void createJobBasic() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/job-scheduling/v1/Job").contentType("application/json")
        ...
        MvcResult jobResult = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void createJobAdvanced() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/job-scheduling/v1/Job")
        ...
        MvcResult paramResult = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID + "/parameters"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void createJobWithJsonDataTypes() throws Exception {
        ...
        MvcResult paramsResult = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID + "/parameters"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void createJobWithTestRunFlag() throws Exception {
        ...
        MvcResult results = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID + "/results"))
                .andExpect(status().isOk())
                .andReturn();
        ...
        MvcResult messages = mockMvc.perform(get("/api/job-scheduling/v1/JobResult/" + jobResult.get("ID") + "/messages").locale(Locale.ENGLISH))
                .andExpect(status().isOk())
                .andReturn();
        ...
        messages = mockMvc.perform(get("/api/job-scheduling/v1/JobResult/" + jobResult.get("ID") + "/messages").locale(Locale.ENGLISH))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void createJobWithTranslation() throws Exception {
        ...
        messages = mockMvc.perform(get("/api/job-scheduling/v1/JobResult/" + jobResult.get("ID") + "/messages").locale(Locale.GERMAN))
                .andExpect(status().isOk())
                .andReturn();
        resultMessages = (JSONArray) cleanData(new JSONArray(messages.getResponse().getContentAsString()));
        resultMessage = resultMessages.getJSONObject(0);
    ...
    public void createJobWithStatusAndDuration() throws Exception {
        ...
        MvcResult jobDetails = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID))
                .andExpect(status().isOk())
                .andReturn();
        cleanData(new JSONObject(jobDetails.getResponse().getContentAsString()));

        MvcResult jobResults = mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID + "/results"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void cancelJob() throws Exception {
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job/" + ID + "/cancel").locale(Locale.ENGLISH))
                .andExpect(status().isNoContent());

        mockMvc.perform(get("/api/job-scheduling/v1/Job/" + ID))
                .andExpect(status().isOk())
    ...
    void getJobParameterDefinitionNotFound() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobParameterDefinition"))
                .andExpect(status().isNotFound());
        mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition/XXX/parameters"))
                .andExpect(status().isNotFound());
    }
    ...
    void getJobParameterNotFound() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobParameter"))
                .andExpect(status().isNotFound());
        mockMvc.perform(get("/api/job-scheduling/v1/Job/XXX/parameters"))
                .andExpect(status().isNotFound());
    }
    ...
    void getJobResultMessageNotFound() throws Exception {
        mockMvc.perform(get("/api/job-scheduling/v1/JobResultMessage"))
                .andExpect(status().isNotFound());
    }
    ...
    void postJobDefinitionReadOnly() throws Exception {
        mockMvc.perform(post("/api/job-scheduling/v1/JobDefinition"))
    ...
    void putJobDefinitionReadOnly() throws Exception {
        mockMvc.perform(put("/api/job-scheduling/v1/JobDefinition/JOB_1"))
                .andExpect(status().isMethodNotAllowed())
    ...
    void deleteJobDefinitionReadOnly() throws Exception {
        mockMvc.perform(delete("/api/job-scheduling/v1/JobDefinition/JOB_1"))
                .andExpect(status().isMethodNotAllowed())
    ...
    void postJobParameterDefinitionReadOnly() throws Exception {
        mockMvc.perform(post("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters"))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(status().reason("Method 'POST' is not supported."));
    }
    ...
    void putJobParameterDefinitionOneKeyReadOnly() throws Exception {
        mockMvc.perform(put("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters/A"))
                .andExpect(status().isNotFound());
    }
    ...
    void putJobParameterDefinitionTwoKeysReadOnly() throws Exception {
        mockMvc.perform(put("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters/A/JOB_1"))
                .andExpect(status().isNotFound());
    }
    ...
    void putJobParameterDefinitionReadOnly() throws Exception {
        mockMvc.perform(put("/api/job-scheduling/v1/JobDefinition('JOB_1')/parameters(name='A',jobName='JOB_1')"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteJobParameterDefinitionOneKeyReadOnly() throws Exception {
        mockMvc.perform(delete("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters/A"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteJobParameterDefinitionTwoKeysReadOnly() throws Exception {
        mockMvc.perform(delete("/api/job-scheduling/v1/JobDefinition/JOB_1/parameters/A/JOB_1"))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteJobParameterDefinitionReadOnly() throws Exception {
        mockMvc.perform(delete("/api/job-scheduling/v1/JobDefinition('JOB_1')/parameters(name='A',jobName='JOB_1')"))
                .andExpect(status().isNotFound());
    }
    ...
    void putJobReadOnly() throws Exception {
        mockMvc.perform(put("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103"))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(status().reason("Method 'PUT' is not supported."));
    }
    ...
    void deleteJobReadOnly() throws Exception {
        mockMvc.perform(delete("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407103"))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(status().reason("Method 'DELETE' is not supported."));
    }
    ...
    void readJobDefinitionWithInvalidSkip() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?skip=A"))
                .andExpect(status().isBadRequest()).andReturn();
        assertNotNull(result.getResolvedException());
        assertEquals(MethodArgumentTypeMismatchException.class, result.getResolvedException().getClass());
        assertEquals("Method parameter 'skip': Failed to convert value of type 'java.lang.String' to required type 'java.lang.Integer'; For input string: \"A\"", result.getResolvedException().getMessage());
    }

    @Test
    @WithMockUser("authenticated")
    void readJobDefinitionWithInvalidTop() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/JobDefinition?top=B"))
                .andExpect(status().isBadRequest()).andReturn();
        assertNotNull(result.getResolvedException());
        assertEquals(MethodArgumentTypeMismatchException.class, result.getResolvedException().getClass());
        assertEquals("Method parameter 'top': Failed to convert value of type 'java.lang.String' to required type 'java.lang.Integer'; For input string: \"B\"", result.getResolvedException().getMessage());
    }

    @Test
    @WithMockUser("authenticated")
    void readJobWithInvalidSkip() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/Job?skip=A"))
                .andExpect(status().isBadRequest()).andReturn();
        assertNotNull(result.getResolvedException());
        assertEquals(MethodArgumentTypeMismatchException.class, result.getResolvedException().getClass());
        assertEquals("Method parameter 'skip': Failed to convert value of type 'java.lang.String' to required type 'java.lang.Integer'; For input string: \"A\"", result.getResolvedException().getMessage());
    ...
    void readJobWithInvalidTop() throws Exception {
        MvcResult result = mockMvc.perform(get("/api/job-scheduling/v1/Job?top=B"))
                .andExpect(status().isBadRequest()).andReturn();
        assertNotNull(result.getResolvedException());
        assertEquals(MethodArgumentTypeMismatchException.class, result.getResolvedException().getClass());
        assertEquals("Method parameter 'top': Failed to convert value of type 'java.lang.String' to required type 'java.lang.Integer'; For input string: \"B\"", result.getResolvedException().getMessage());
    ...
    void createJobWithWrongData() throws Exception {
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                        .content("{}")
                        .contentType("application/json").locale(Locale.ENGLISH))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.code").value("jobDefinitionNotFound"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobDefinitionNotFound", new String[]{null}, Locale.ENGLISH)));
        JSONObject job = new JSONObject(Map.of(
                "name", "JOB_X"
        ));
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.code").value("jobDefinitionNotFound"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobDefinitionNotFound", new String[]{"JOB_X"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1"
        ));
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                        .content(job.toString())
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("referenceIDNoUUID", new String[]{"4711"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327"
        ));
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterRequired", new String[]{"A"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "startDateTime", "X"
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("startDateTimeNotSupported", new String[]{"JOB_1"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterNotKnown", new String[]{"X"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterValueInvalidType", new String[]{"xxx", "C", "boolean"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterReadOnly", new String[]{"B"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterValueRequired", new String[]{"C"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.code").value("jobParameterValueInvalidType"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterValueInvalidType", new String[]{"X", "C", "boolean"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.code").value("jobParameterValueInvalidType"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterValueInvalidType", new String[]{"X", "D", "number"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "parameters", new JSONArray(List.of(
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.code").value("jobParameterValueInvalidType"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobParameterValueInvalidType", new String[]{"X", "E", "datetime"}, Locale.ENGLISH)));
        job = new JSONObject(Map.of(
                "name", "JOB_1",
                "referenceID", "c1253940-5f25-4a0b-8585-f62bd085b327",
                "results", new JSONArray(List.of(
                        new JSONObject(Map.of(
                                "type", ResultTypeCode.LINK,
                                "link", "https://sap.com"
                        )))),
                "parameters", new JSONArray(List.of(
                        new JSONObject(Map.of(
    ...
    public void cancelJobNotFound() throws Exception {
        mockMvc.perform(post("/api/job-scheduling/v1/Job/3a89dfec-59f9-4a91-90fe-3c7ca7407104/cancel").locale(Locale.ENGLISH))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.code").value("jobNotFound"))
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobNotFound", new String[]{"3a89dfec-59f9-4a91-90fe-3c7ca7407104"}, Locale.ENGLISH)));
    }
    ...
    public void cancelJobAlreadyCanceled() throws Exception {
        ...
        mockMvc.perform(post("/api/job-scheduling/v1/Job/" + ID + "/cancel").locale(Locale.ENGLISH))
                ...
                .andExpect(jsonPath("$.message").value(messageProvider.get("jobCannotBeCanceled", new String[]{"canceled"}, Locale.ENGLISH)));
