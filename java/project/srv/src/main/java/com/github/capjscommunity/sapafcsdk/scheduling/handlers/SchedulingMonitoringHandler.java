...
import com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingmonitoringservice.Job;
import com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingmonitoringservice.JobCancelContext;
import com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingmonitoringservice.Job_;
import com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingmonitoringservice.SchedulingMonitoringService_;
import com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingproviderservice.SchedulingProviderService;
...
public class SchedulingMonitoringHandler implements EventHandler {
  ...
  public void cancelJob(JobCancelContext context) {
    String ID = CqnAnalyzer.create(context.getModel())
      ...
      .get("ID")
      .toString();
    com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingproviderservice.Job_ job = CQL.entity(
      com.github.capjscommunity.sapafcsdk.model.sapafcsdk.scheduling.schedulingproviderservice.Job_.class
    ).filter(j -> j.ID().eq(ID));
