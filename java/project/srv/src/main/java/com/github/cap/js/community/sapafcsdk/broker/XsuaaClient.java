...
public class XsuaaClient {
  ...
  public Mono<XsuaaData> existsXsuaaClone(String serviceInstanceId) {
    ...
    return getOauthToken(xsuaaData.getClientId(), xsuaaData.getClientSecret(), xsuaaData.getUrl())
      ...
      .doOnSuccess(e ->
        log.info("Get request successful for xsuaa clone for Service Instance id '{}'", serviceInstanceId)
      );
  }
  ...
  public Mono<Void> deleteXsuaaClone(String serviceInstanceId) {
    ...
    return getOauthToken(xsuaaData.getClientId(), xsuaaData.getClientSecret(), xsuaaData.getUrl())
      ...
      .doOnSuccess(e -> log.info("Deleting successful for xsuaa clone for Service Instance id '{}'", serviceInstanceId)
      );
  }
  ...
  private Map<String, Object> buildCreateClonesBody(String xsappnameClone) {
    ...
    return Map.of("xsappname", xsappnameClone, "oauth2-configuration", Map.of("credential-types", credentialsTypes));
  }
