...
public class SchedulingProviderController {
  ...
  public StreamingResponseBody jobResultData(
    ...
    Select<com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.JobResult_> query = Select.from(
      com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.Scheduling_.JOB_RESULT
    ).byId(ID);
    Optional<com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.JobResult> _jobResult = persistenceService
      .run(query)
      .first(com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.JobResult.class);
    if (_jobResult.isEmpty()) {
      response.setStatus(HttpStatus.NOT_FOUND.value());
      return null;
    }
    com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.JobResult jobResult = _jobResult.get();
    String dispositionType = cdsModel
      .getEntity(com.github.cap.js.community.sapafcsdk.model.sapafcsdk.scheduling.JobResult_.CDS_NAME)
      .getElement("data")
